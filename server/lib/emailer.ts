...
class Emailer {
  ...
  addNewVideoFromSubscriberNotification (to: string[], video: VideoModel) {
    ...
    const text = `Hi dear user,\n\n` +
      ...
      `\n\n` +
      `Cheers,\n` +
      `${CONFIG.EMAILS.SIGNATURE}`

    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + channelName + ' just published a new video',
      text
    }
  ...
  addNewFollowNotification (to: string[], actorFollow: ActorFollowModel, followType: 'account' | 'channel') {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + 'New follower on your channel ' + followingName,
      text
    }
  ...
  addNewInstanceFollowerNotification (to: string[], actorFollow: ActorFollowModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + 'New instance follower',
      text
    }
  ...
  myVideoPublishedNotification (to: string[], video: VideoModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + `Your video ${video.name} is published`,
      text
    }
  ...
  myVideoImportSuccessNotification (to: string[], videoImport: VideoImportModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + `Your video import ${videoImport.getTargetIdentifier()} is finished`,
      text
    }
  ...
  myVideoImportErrorNotification (to: string[], videoImport: VideoImportModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + `Your video import ${videoImport.getTargetIdentifier()} encountered an error`,
      text
    }
  ...
  addNewCommentOnMyVideoNotification (to: string[], comment: VideoCommentModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + 'New comment on your video ' + video.name,
      text
    }
  ...
  addNewCommentMentionNotification (to: string[], comment: VideoCommentModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + 'Mention on video ' + video.name,
      text
    }
  ...
  addVideoAbuseModeratorsNotification (to: string[], videoAbuse: VideoAbuseModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + 'Received a video abuse',
      text
    }
  ...
  addVideoAutoBlacklistModeratorsNotification (to: string[], video: VideoModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + 'An auto-blacklisted video is awaiting review',
      text
    }
  ...
  addNewUserRegistrationNotification (to: string[], user: UserModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + 'New user registration on ' + WEBSERVER.HOST,
      text
    }
  ...
  addVideoBlacklistNotification (to: string[], videoBlacklist: VideoBlacklistModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + `Video ${videoName} blacklisted`,
      text
    }
  ...
  addVideoUnblacklistNotification (to: string[], video: VideoModel) {
    ...
    const emailPayload: EmailPayload = {
      to,
      subject: CONFIG.EMAILS.PREFIX + `Video ${video.name} unblacklisted`,
      text
    }
  ...
  addPasswordResetEmailJob (to: string, resetPasswordUrl: string) {
    ...
    const emailPayload: EmailPayload = {
      to: [ to ],
      subject: CONFIG.EMAILS.PREFIX + 'Reset your password',
      text
    }
  ...
  addVerifyEmailJob (to: string, verifyEmailUrl: string) {
    ...
    const emailPayload: EmailPayload = {
      to: [ to ],
      subject: CONFIG.EMAILS.PREFIX + 'Verify your email',
      text
    }
  ...
  addUserBlockJob (user: UserModel, blocked: boolean, reason?: string) {
    ...
    const emailPayload: EmailPayload = {
      to: [ to ],
      subject: CONFIG.EMAILS.PREFIX + 'Account ' + blockedWord,
      text
    }
  ...
  addContactFormJob (fromEmail: string, fromName: string, body: string) {
    ...
    const emailPayload: EmailPayload = {
      ...
      subject: CONFIG.EMAILS.PREFIX + 'Contact form submitted',
      text
    }
