...
function buildOEmbed (options: {
  ...
  const html = nsfw
    ? `<iframe  style='display:block;' srcdoc="<html><body style='background-color:#282828;'>
      <p style='color:#EEEEEE; text-align: center; vertical-align: middle; font-size: 22px; font-weight: 500;'>
      The content of this video is marked as sensitive.<br><br><a style = 'color:#EEEEEE' href ='${req.query.url}' 
