...
function checkMissedConfig () {
  const required = [ 'listen.port', 'listen.hostname',
    ...
    'object_storage.enabled', 'object_storage.endpoint', 'object_storage.region','object_storage.upload_acl.enabled', 'object_storage.upload_acl.public',
    'object_storage.upload_acl.private','object_storage.bucket_policy.enabled','object_storage.bucket_policy.private','object_storage.bucket_policy.public', 'object_storage.proxy.proxify_private_files', 'object_storage.credentials.access_key_id',
