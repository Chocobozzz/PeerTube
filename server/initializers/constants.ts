...
function updateWebserverUrls () {
  ...
  WEBSERVER.RTMP_URL = 'rtmp://' + (CONFIG.LIVE.RTMP.HOSTNAME || CONFIG.WEBSERVER.HOSTNAME) +
    ':' + CONFIG.LIVE.RTMP.PORT + '/' + VIDEO_LIVE.RTMP.BASE_PATH
  WEBSERVER.RTMPS_URL = 'rtmps://' + (CONFIG.LIVE.RTMPS.HOSTNAME || CONFIG.WEBSERVER.HOSTNAME) +
    ':' + CONFIG.LIVE.RTMPS.PORT + '/' + VIDEO_LIVE.RTMP.BASE_PATH
}
