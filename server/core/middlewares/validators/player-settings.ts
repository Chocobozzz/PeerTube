...
import { checkCanManageAccount } from './shared/users.js'
import { areValidationErrors, isValidVideoIdParam } from './shared/utils.js'
import { checkCanSeeVideo, checkCanManageVideo, doesVideoExist } from './shared/videos.js'
...
export const getChannelPlayerSettingsValidator = [
  ...
  (req: express.Request, res: express.Response, next: express.NextFunction) => {
    ...
    if (req.query.raw === true) {
      ...
      if (!checkCanManageAccount({ account, user, req, res, specialRight: UserRight.MANAGE_ANY_VIDEO_CHANNEL })) return false
    }
