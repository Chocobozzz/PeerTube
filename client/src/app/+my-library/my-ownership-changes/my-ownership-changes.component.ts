...
import { MyAcceptChangeOwnershipComponent } from './my-accept-change-ownership/my-accept-change-ownership.component'
...
@Component({
  ...
  imports: [
    ...
    NgClass,
    MyAcceptChangeOwnershipComponent,
    PTDatePipe,
    VideoCellComponent,
    NumberFormatterPipe,
    TableComponent,
...
export class MyOwnershipChangesComponent {
  ...
  readonly myAcceptChangeOwnershipComponent = viewChild<MyAcceptChangeOwnershipComponent>('myAcceptChangeOwnershipComponent')
  ...
  openAcceptModal (entries: ChangeOwnership[]) {
    this.myAcceptChangeOwnershipComponent().show(entries)
  }
